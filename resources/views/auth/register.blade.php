<x-guest-layout>
    <div class="auth-heading">
        ...
        <p>Free to start — set up in under 2 minutes</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="auth-form">
        ...
        <div class="auth-field">
            ...
            <div class="auth-input-group">
                <span class="auth-input-icon">
                    <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z"/></svg>
                </span>
                <input id="name" type="text" name="name" class="auth-input" value="{{ old('name') }}" required autofocus autocomplete="name" placeholder="John Kamau">
            </div>
        ...
        <div class="auth-field">
            ...
            <div class="auth-input-group">
                ...
                <input id="email" type="email" name="email" class="auth-input" value="{{ old('email') }}" required autocomplete="username" placeholder="you@example.com">
            </div>
        ...
        <div class="auth-field">
            ...
            <div class="auth-input-group">
                ...
                <input id="password" type="password" name="password" class="auth-input has-toggle" required autocomplete="new-password" placeholder="Min. 8 characters">
            ...
            <p class="auth-hint">Use at least 8 characters with letters and numbers</p>
        ...
        <div class="auth-field">
            ...
            <div class="auth-input-group">
                <span class="auth-input-icon">
                    <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                </span>
                <input id="password_confirmation" type="password" name="password_confirmation" class="auth-input" required autocomplete="new-password" placeholder="Repeat your password">
            </div>
